    ...
    EIP712
{
    ...
    event SignatureSeriesAssetDestroyed(
    ...
    function createAsset(
        ...
        emit SignatureSeriesAssetCreated(
            currentTokenID,
            _msgSender(),
            metadataURI
        );
    ...
    function lazyAssetCreation(
        ...
        require(
            flowRoles.isOperator(recover(voucher)),
            "SignatureSeries: Invalid Signature!"
        );
        if (nftPrice != 0) {
