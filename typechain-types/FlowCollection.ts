...
export interface FlowCollectionInterface extends utils.Interface {
  contractName: "FlowCollection";
  functions: {
    "balanceOf(address,uint256)": FunctionFragment;
    "balanceOfBatch(address[],uint256[])": FunctionFragment;
    "createAsset(uint256,bytes,string)": FunctionFragment;
    "delegateAssetCreation(address,uint256,bytes,string)": FunctionFragment;
...
export interface FlowCollection extends BaseContract {
  contractName: "FlowCollection";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlowCollectionInterface;
