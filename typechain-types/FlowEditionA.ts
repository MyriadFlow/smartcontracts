...
export interface FlowEditionAInterface extends utils.Interface {
  contractName: "FlowEditionA";
  functions: {
  ...
  events: {
    ...
    "AssetCreated(uint256,address)": EventFragment;
...
export interface FlowEditionA extends BaseContract {
  contractName: "FlowEditionA";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlowEditionAInterface;
