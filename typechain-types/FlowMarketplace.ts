...
export interface FlowMarketplaceInterface extends utils.Interface {
...
export interface FlowMarketplace extends BaseContract {
  contractName: "FlowMarketplace";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FlowMarketplaceInterface;
