...
export interface IFlowAccessControlInterface extends utils.Interface {
  contractName: "IFlowAccessControl";
  functions: {
...
export interface IFlowAccessControl extends BaseContract {
  contractName: "IFlowAccessControl";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IFlowAccessControlInterface;
